...
INSERT INTO account (id, enabled, username, password) VALUES (1, true, 'admin', '$2a$12$6chVYmeMMb0OlIB40g4wReZLnohUG.pAWAajJU8iItvzwm/o6ObIW');
...
INSERT INTO role_privileges (role_role_id, privileges_privilege_id) VALUES (1, 1);
  INSERT INTO role_privileges (role_role_id, privileges_privilege_id) VALUES (1, 2);
    INSERT INTO role_privileges (role_role_id, privileges_privilege_id) VALUES (1, 3);
